  ...
  return (
    <div className="app">
      ...
      <nav className="app__nav" aria-label="功能页面切换">
        ...
        <button
          className={`app__tab${page === "settings" ? " app__tab--active" : ""}`}
      ...
      <main className="app__main">
        {/* All pages stay mounted so chat history and generated images survive tab switches. */}
        ...
        <div className={`app__page${page === "settings" ? "" : " app__page--hidden"}`}>
          <SettingsPage />
        </div>
      </main>
    </div>
